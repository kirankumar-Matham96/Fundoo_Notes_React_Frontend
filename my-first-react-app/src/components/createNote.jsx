    ...
    <div className='main_note'>
      ...
      <div className='row1'>
          <div className="input-group">
            <input className='mb-0 mr-1' type='text' name='title' value={note.title} onChange={inputEvent} placeholder='Title' />
          ...
          <textarea className='content-area' name='content' value={note.content} onChange={ inputEvent } placeholder='Take a note...'></textarea>
